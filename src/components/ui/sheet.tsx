...
function SheetContent({
  ...
  // SSR-safe: render nothing on the server (sheets are never open on first paint)
  ...
  const content = (
    <SheetPrimitive.Content
      ...
      className={cn(
        ...
        side === "bottom" &&
          "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 bottom-0 h-auto border-t rounded-t-xl pb-[env(safe-area-inset-bottom,0px)]",
        className
      )}
      {...props}
    >
