...
CREATE TABLE "PipelineRun" (
    ...
    "status" TEXT NOT NULL DEFAULT 'PENDING',
    "pipelineType" TEXT NOT NULL DEFAULT 'IMPORT',
    "startedAt" TIMESTAMP(3),
    "completedAt" TIMESTAMP(3),
    "errorMessage" TEXT,
    "checkpoint" JSONB,
...
-- CreateTable
CREATE TABLE "AiOperationMapping" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "AiOperationMapping_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "ContentDuplicate" (
    "id" TEXT NOT NULL,
    "importedContentId" TEXT NOT NULL,
    "matchedContentType" TEXT NOT NULL,
    "matchedContentId" TEXT NOT NULL,
    "similarityScore" DOUBLE PRECISION NOT NULL,
    "matchMethod" TEXT NOT NULL,
    "metadata" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "ContentDuplicate_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "AnalyticsDailyFact" (
    "id" BIGSERIAL NOT NULL,
    ...
    CONSTRAINT "AnalyticsDailyFact_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ContentRewrite" (
    ...
    CONSTRAINT "ContentRewrite_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "SourceConfig_sourceType_isActive_idx" ON "SourceConfig"("sourceType", "isActive");

-- CreateIndex
CREATE INDEX "SourceConfig_url_idx" ON "SourceConfig"("url");

-- CreateIndex
CREATE INDEX "SourceConfig_isActive_deletedAt_idx" ON "SourceConfig"("isActive", "deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "PipelineRun_correlationId_key" ON "PipelineRun"("correlationId");

-- CreateIndex
CREATE INDEX "PipelineRun_status_idx" ON "PipelineRun"("status");

-- CreateIndex
CREATE INDEX "PipelineRun_sourceId_idx" ON "PipelineRun"("sourceId");
...
-- CreateIndex
CREATE INDEX "PipelineRun_status_scheduledAt_idx" ON "PipelineRun"("status", "scheduledAt");

-- CreateIndex
CREATE INDEX "StageExecution_pipelineId_stageOrder_idx" ON "StageExecution"("pipelineId", "stageOrder");

-- CreateIndex
CREATE INDEX "StageExecution_pipelineId_status_idx" ON "StageExecution"("pipelineId", "status");

-- CreateIndex
CREATE INDEX "StageExecution_stageName_status_idx" ON "StageExecution"("stageName", "status");

-- CreateIndex
CREATE INDEX "PublishSchedule_status_scheduledAt_idx" ON "PublishSchedule"("status", "scheduledAt");

-- CreateIndex
CREATE INDEX "PublishSchedule_entityType_entityId_idx" ON "PublishSchedule"("entityType", "entityId");

-- CreateIndex
CREATE INDEX "PublishSchedule_status_publishedAt_idx" ON "PublishSchedule"("status", "publishedAt");
...
-- CreateIndex
CREATE INDEX "AiProviderConfig_providerType_idx" ON "AiProviderConfig"("providerType");

-- CreateIndex
CREATE INDEX "AiOperationMapping_operation_isActive_idx" ON "AiOperationMapping"("operation", "isActive");

-- CreateIndex
CREATE UNIQUE INDEX "AiOperationMapping_providerId_operation_key" ON "AiOperationMapping"("providerId", "operation");
...
-- CreateIndex
CREATE INDEX "AutomationRule_ruleType_isActive_idx" ON "AutomationRule"("ruleType", "isActive");

-- CreateIndex
CREATE INDEX "ReviewTask_status_idx" ON "ReviewTask"("status");

-- CreateIndex
CREATE INDEX "ReviewTask_entityType_entityId_idx" ON "ReviewTask"("entityType", "entityId");

-- CreateIndex
CREATE INDEX "ReviewTask_reviewerId_idx" ON "ReviewTask"("reviewerId");

-- CreateIndex
CREATE INDEX "ReviewTask_correlationId_idx" ON "ReviewTask"("correlationId");
...
-- CreateIndex
CREATE INDEX "MediaAsset_storageUrl_idx" ON "MediaAsset"("storageUrl");

-- CreateIndex
CREATE INDEX "ImportedContent_contentHash_idx" ON "ImportedContent"("contentHash");

-- CreateIndex
CREATE INDEX "ImportedContent_sourceId_idx" ON "ImportedContent"("sourceId");

-- CreateIndex
CREATE INDEX "ImportedContent_status_idx" ON "ImportedContent"("status");

-- CreateIndex
CREATE INDEX "ImportedContent_sourceUrl_idx" ON "ImportedContent"("sourceUrl");

-- CreateIndex
CREATE INDEX "ImportedContent_correlationId_idx" ON "ImportedContent"("correlationId");

-- CreateIndex
CREATE INDEX "ContentDuplicate_importedContentId_idx" ON "ContentDuplicate"("importedContentId");

-- CreateIndex
CREATE INDEX "ContentDuplicate_matchedContentType_matchedContentId_idx" ON "ContentDuplicate"("matchedContentType", "matchedContentId");

-- CreateIndex
CREATE INDEX "ContentDuplicate_similarityScore_idx" ON "ContentDuplicate"("similarityScore");
...
-- CreateIndex
CREATE INDEX "OutboxMessage_eventType_idx" ON "OutboxMessage"("eventType");

-- CreateIndex
CREATE INDEX "InboxMessage_consumerName_processedAt_idx" ON "InboxMessage"("consumerName", "processedAt");

-- CreateIndex
CREATE INDEX "InboxMessage_consumerName_createdAt_idx" ON "InboxMessage"("consumerName", "createdAt");

-- CreateIndex
CREATE INDEX "InboxMessage_createdAt_idx" ON "InboxMessage"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "InboxMessage_messageId_consumerName_key" ON "InboxMessage"("messageId", "consumerName");
...
-- CreateIndex
CREATE INDEX "AiRequestLog_correlationId_idx" ON "AiRequestLog"("correlationId");
...
-- CreateIndex
CREATE INDEX "PipelineEvent_pipelineId_idx" ON "PipelineEvent"("pipelineId");

-- CreateIndex
CREATE INDEX "PipelineEvent_eventType_idx" ON "PipelineEvent"("eventType");

-- CreateIndex
CREATE INDEX "PipelineEvent_correlationId_idx" ON "PipelineEvent"("correlationId");

-- CreateIndex
CREATE INDEX "AnalyticsDailyFact_date_idx" ON "AnalyticsDailyFact"("date");

-- CreateIndex
CREATE INDEX "AnalyticsDailyFact_metric_date_idx" ON "AnalyticsDailyFact"("metric", "date");

-- CreateIndex
CREATE UNIQUE INDEX "AnalyticsDailyFact_date_metric_dimension_key" ON "AnalyticsDailyFact"("date", "metric", "dimension");
...
-- CreateIndex
CREATE UNIQUE INDEX "SchedulerJob_name_key" ON "SchedulerJob"("name");

-- CreateIndex
CREATE INDEX "SchedulerJob_isActive_nextRunAt_idx" ON "SchedulerJob"("isActive", "nextRunAt");

-- CreateIndex
CREATE INDEX "SchedulerJob_jobType_isActive_idx" ON "SchedulerJob"("jobType", "isActive");

-- CreateIndex
CREATE INDEX "DeadLetterItem_queueName_status_idx" ON "DeadLetterItem"("queueName", "status");

-- CreateIndex
CREATE INDEX "DeadLetterItem_status_idx" ON "DeadLetterItem"("status");

-- CreateIndex
CREATE INDEX "DeadLetterItem_createdAt_idx" ON "DeadLetterItem"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "AutomationSetting_key_key" ON "AutomationSetting"("key");

-- CreateIndex
CREATE INDEX "ContentRewrite_contentImportId_idx" ON "ContentRewrite"("contentImportId");

-- CreateIndex
CREATE INDEX "ContentRewrite_status_idx" ON "ContentRewrite"("status");

-- CreateIndex
CREATE INDEX "ContentRewrite_correlationId_idx" ON "ContentRewrite"("correlationId");
...
-- AddForeignKey
ALTER TABLE "PipelineRun" ADD CONSTRAINT "PipelineRun_sourceId_fkey" FOREIGN KEY ("sourceId") REFERENCES "SourceConfig"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "StageExecution" ADD CONSTRAINT "StageExecution_pipelineId_fkey" FOREIGN KEY ("pipelineId") REFERENCES "PipelineRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AiOperationMapping" ADD CONSTRAINT "AiOperationMapping_providerId_fkey" FOREIGN KEY ("providerId") REFERENCES "AiProviderConfig"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContentDuplicate" ADD CONSTRAINT "ContentDuplicate_importedContentId_fkey" FOREIGN KEY ("importedContentId") REFERENCES "ImportedContent"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PipelineEvent" ADD CONSTRAINT "PipelineEvent_pipelineId_fkey" FOREIGN KEY ("pipelineId") REFERENCES "PipelineRun"("id") ON DELETE SET NULL ON UPDATE CASCADE;
